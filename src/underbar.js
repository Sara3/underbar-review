(function() {
  ...
  _.each = function(collection, iterator) {
    // no return value
    // runs iterator function on each item
    // see if collection is object OR array
      // if collection is array
      // WHAT ABT ARRAY LIKE OBJECTS
    if (Array.isArray(collection)) {
      ...
      for (let key in collection) {
        ...
        // loop thru array
          // call iterator(element, i, collection);
  
      
      // if collection is object
        // loop thru object
          // call iterator(obj.key, key, obj);
  };
